...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    $.get(`http://ec2-13-52-163-168.us-west-1.compute.amazonaws.com:3001/houses/${id}`, (data) => {
      ...
      $.get(`http://ec2-13-52-163-168.us-west-1.compute.amazonaws.com:3001/prices/${id}`, (data) => {
