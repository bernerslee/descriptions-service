...
class App extends React.Component {
  ...
  componentDidMount() {
    ...
    $.get(`http://ec2-54-183-221-61.us-west-1.compute.amazonaws.com:3001/houses/${id}`, (data) => {
      ...
      $.get(`http://ec2-54-183-221-61.us-west-1.compute.amazonaws.com:3001/prices/${id}`, (data) => {
